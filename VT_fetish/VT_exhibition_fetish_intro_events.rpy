...
label VT_exhibition_fetish_generic_intro_label(the_person):
    ...
    menu:
        "Ok, go ahead, make my day":
            ...
            call get_fucked(the_person, the_goal="get mc off", start_position = blowjob, start_object = make_floor(), private=False, skip_intro = True, allow_continue = False) from _call_get_fucked_VT_exhibition_fetish_generic_intro_01
            $ VT_add_exhibition_fetish(the_person)
