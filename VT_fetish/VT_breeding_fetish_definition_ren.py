...
VT_breeding_fetish_high_fertility_crisis = ActionMod("Breeding fetish desperation", VT_breeding_fetish_high_fertility_crisis_requirement, "VT_breeding_fetish_high_fertility_crisis_label",
