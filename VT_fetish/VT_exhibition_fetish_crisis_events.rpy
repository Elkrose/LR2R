label VT_exhibition_fetish_morning_shower_label():
    ...
    call get_fucked(the_person, sex_path = build_blowjob_path(the_person), start_object = make_floor(), skip_intro = True, allow_continue = False) from _call_get_fucked_VT_exhibition_fetish_morning_shower_VT1
    "[the_person.possessive_title!c] looks up at you and she looks you right in the eyes."
    the_person "We aren't done yet!"
    ...
    the_person "By the way, I filmed this for my pleasuring for later."
    "As she leaves the room, you look up and see the red blinking light of a tiny webcam..."

    python:
        report_log = create_report_log({"was_public": True})
        the_person.apply_planned_outfit()
        mc.change_location(bedroom)
        clear_scene()
    return

label VT_exhibition_fetish_employee_casual_request_label():
    ...
    "You step out of your office and massage your lower back as you walk to the lobby."
    $ the_person.draw_person()
    "You look up and see [the_person.possessive_title] pacing in the lobby."
    if mc.business.is_open_for_business:
        mc.name "Hello [the_person.title], what's going on?"
        "[the_person.possessive_title!c] spots you and smiles and walks towards you."
        the_person "Hey [the_person.mc_title]. So... I walked by your office a minute ago and I was just thinking that it's been a while..."
...
label VT_exhibition_fetish_non_employee_dosage_request_label():
    ...
    menu:
        "All right":
            if mc.is_at_office:
                ...
                the_person "No problem, I'll be in at your business in 10 minutes."
                if not mc.location == lobby:
                    "You decide to go to await [the_person.possessive_title]'s arrival in the lobby."
                    $ mc.change_location(lobby)
