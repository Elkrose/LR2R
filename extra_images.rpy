...
###### Threesome - note polyamorous added
    ...
    image threesometriad = "[threesometriad_image.filename]"
    image opentriad = "[opentriad_image.filename]"
    image knowthreesome = "[knowthreesome_image.filename]"

### Personalities #####
    image bimbo = "[bimbo_image.filename]"
    image cougar = "[cougar_image.filename]"
    image alpha = "[alpha_image.filename]"
    image relaxed = "[relaxed_image.filename]"
...
##### Condom Icons #####
    ...
    image nocondom = "[nocondom_image.filename]"
...
### Oral Virgin Flag
    ...
    image openmouth = "[openmouth_image.filename]"
...
### Vaginal Virgin Flag
    ...
    image spreadvag = "[spreadvag_image.filename]"
...
### Thermometer - Arousal
    image tempbroke = "[tempbroke_image.filename]"
    image temp90 = "[temp90_image.filename]"
    image temp80 = "[temp80_image.filename]"
    image temp70 = "[temp70_image.filename]"
    image tempnormal = "[tempnormal_image.filename]"
    image tempblank = "[tempblank_image.filename]"
...
###### Creampie Filling ##############
    image openpeach = "[openpeach_image.filename]"

###### Cum Fetish ##############

##### overtop Icons #####
    image bc_cum = "[bc_cum_image.filename]"
    image dislike = "[dislike_image.filename]"
